...
export class ProductoService {
  ...
  actulizar_producto_admin(data: any, id: any, token: any): Observable<any> {
    if (data.portada) {
      let headers = new HttpHeaders({ Authorization: token });
      ...
      return this._http.put(this.url + 'actulizar_producto_admin/' + id, fd, {
        headers: headers,
      });
    } else {
      let headers = new HttpHeaders({
      ...
      return this._http.put(this.url + 'actulizar_producto_admin/' + id, data, {
        headers: headers,
      });
    }
  }
  ...
  actulizar_producto_variedades_admin(
    ...
    return this._http.put(
      this.url + 'actulizar_producto_variedades_admin/' + id,
      data,
      {
        headers: headers,
      }
